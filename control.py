...
BOT_CLIENT_IP = "192.168.0.150"     # 客户端主动HTTP端口 / 可以选择auto
BOT_HOST_HTTP_LISTEN_PORT = 5700    # 服务器端监听端口
BOT_HOST_IP = "192.168.0.107"       # 服务器端IP
...
DEBUG_MODE = True                  # 开启debug输出
HEARTBEAT_INTETNAL = 5              # 心跳包间隔时间
LOG_LEN_MAX = 1000                  # log输出最大长度
COMMAND_SLEEP_TIME = 2              # 命令等待时间
